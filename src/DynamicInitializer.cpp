...
{
    ScopedTrace tracer("DynamicInitializer::tryDynInit");
...
{
    ScopedTrace tracer("DynamicInitializer::processIMU");
...
{
    ScopedTrace tracer("DynamicInitializer::processImage");
...
{
    ScopedTrace tracer("DynamicInitializer::initialStructure");
...
{
    ScopedTrace tracer("DynamicInitializer::visualInitialAlign");
    VectorXd x;
    // solve scale
...
{
    ScopedTrace tracer("DynamicInitializer::relativePose");
...
{
    ScopedTrace tracer("DynamicInitializer::slideWindow");
                                            ...
                                            Eigen::Vector3d &m_gyro_old, Eigen::Vector3d &m_acc_old, IMUState &imu_state)
{
    ...
    ScopedTrace tracer("DynamicInitializer::assignInitialState");
