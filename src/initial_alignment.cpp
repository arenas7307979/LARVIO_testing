...
{
    ScopedTrace tracer("LarVio::solveGyroscopeBias");
    Matrix3d A;
    Vector3d b;
    Vector3d delta_bg;
    A.setZero();
...
{
    ScopedTrace tracer("LarVio::TangentBasis");
    Vector3d b, c;
...
{
    ScopedTrace tracer("LarVio::RefineGravity");
...
{
    ScopedTrace tracer("LarVio::LinearAlignment");
    int all_frame_count = all_image_frame.size();
...
{
    ScopedTrace tracer("LarVio::VisualIMUAlignment");
