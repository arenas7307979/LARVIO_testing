...
ImageProcessor::ImageProcessor(std::string &config_file_) : config_file(config_file_)
{
...
bool ImageProcessor::loadParameters()
{
    ...
    ScopedTrace tracer("ImageProcessor::loadParameters");
...
{
    ScopedTrace tracer("ImageProcessor::processImage");
...
{
    ScopedTrace tracer("ImageProcessor::integrateImuData");
...
{
    ScopedTrace tracer("ImageProcessor::predictFeatureTracking");
...
{
    ScopedTrace tracer("ImageProcessor::rescalePoints");
    scaling_factor = 0.0f;
...
{
    ScopedTrace tracer("ImageProcessor::createImagePyramids");
...
{
    ScopedTrace tracer("ImageProcessor::initializeFirstFrame");
    // Get current image
...
bool ImageProcessor::initializeFirstFeatures(
    const std::vector<ImuData> &imu_msg_buffer)
{
    ScopedTrace tracer("ImageProcessor::initializeFirstFeatures");
...
{
    ScopedTrace tracer("ImageProcessor::trackFeatures");
...
{
    ScopedTrace tracer("ImageProcessor::trackNewFeatures");
...
{
    ScopedTrace tracer("ImageProcessor::findNewFeaturesToBeTracked");
    ...
    const cv::Vec4d &new_intrinsics)
{
    ...
    ScopedTrace tracer("ImageProcessor::undistortPoints");
...
void ImageProcessor::getFeatureMsg(MonoCameraMeasurementPtr feature_msg_ptr)
{
    ...
    ScopedTrace tracer("ImageProcessor::getFeatureMsg");
